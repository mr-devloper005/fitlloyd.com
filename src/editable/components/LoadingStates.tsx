...
export function PageLoadingState({ label = 'Loading visual page', className }: LoadingStateProps) {
  return (
...
export function DetailLoadingState({ label = 'Loading visual detail', className }: LoadingStateProps) {
  return (
