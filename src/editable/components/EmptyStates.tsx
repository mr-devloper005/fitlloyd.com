...
export function EmptyState({
  title = 'No visual content published here yet',
  description = 'Fresh image posts, galleries, and creative resources will appear here automatically once this section has published content.',
...
export function TaskEmptyState({ taskLabel = 'posts', className }: { taskLabel?: string; className?: string }) {
  return (
    <EmptyState
      ...
      description={`Published ${taskLabel} for fitlloyd.com will appear here automatically. The visual layout stays ready even when the feed is empty.`}
